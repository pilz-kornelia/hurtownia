	...
	function register(){
		...
		if (count($errors) == 0) {
			...
			if (isset($_POST['user_type'])) {
				...
				$query = "INSERT INTO users (username, city, zipcode, adress, email, user_type, password) 
						  VALUES('$username', '$city', '$zipcode', '$adress','$email', '$user_type', '$password')";
				mysqli_query($db, $query);
				$_SESSION['success']  = "New user successfully created!!";
				header('location: home.php');
			}else{
				$query = "INSERT INTO users (username, city, zipcode, adress, email, user_type, password) 
						  VALUES('$username', '$city', '$zipcode', '$adress', '$email', 'user', '$password')";
				mysqli_query($db, $query);
